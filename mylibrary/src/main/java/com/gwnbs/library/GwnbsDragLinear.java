...
public class GwnbsDragLinear extends LinearLayout {
    private static final String TAG = GwnbsDragLinear.class.getSimpleName();
    ...
    public GwnbsDragLinear(Context context) {
        this(context, null);
    }

    public GwnbsDragLinear(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    private final LongClickDragListener mLongClickDragListener = new LongClickDragListener();
